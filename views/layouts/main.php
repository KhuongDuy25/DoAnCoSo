...
<body>
    ...
    <header>
        ...
        <div class="user-option">
            ...
            <div class="submenu">
                <ul>
                    <li><a href="/dangnhap" style="color: white">Đăng nhập</a></li>
                    <?php 
                        if(empty($_SESSION['user'])) echo '<li><a href="/dangky" style="color: white">Đăng ký</a></li>';
                        else echo '<li><a href="/lichsudathang" style="color: white">Lịch sử đặt hàng</a></li>';
                    ?>
                    <li><a href="#" style="color: white">Cập nhật thông tin</a></li>
                    <hr style="margin: 4px 0;">
                    <li><a href="/dangxuat" style="color: white">Đăng xuất</a></li>
                </ul>
            </div>
        </div>
    </header>
    ...
    <footer>
        ...
        <div class="footer-content">
            ...
            <div class="coppyright">&copy; 2024 Đồ Án Cơ Sở Nhóm 2 <a href="doancosonhom2@gmail.com">(Nhom2DoAnCoSo@gmail.com)</a></div>
        </div>      
    </footer>
